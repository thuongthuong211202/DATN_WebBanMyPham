...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		//đường dẫn thiết lập lưu file
        BaseUrl = "/Uploads/";

		// The phisical directory in the server where the file will end up. If
		// đường dẫn đến máy chủ
		...
		// thiết lập hình ảnh thu nhỏ mặc định
		...
		// ==============================================================================
		//thiết lập các loại file có thể lưu trên server
		DefaultResourceTypes = "";

		ResourceType type;

		type = ResourceType.Add( "Files" );
		type.Url = BaseUrl + "files/"; //đường dẫn tương đối
